    ...
    return (
      ...
      >
        ...
        <p>
          ...
          <L to={LINKS[2]}>Computer Science</L> with Honors. Outside of work, I
          like to <L to={LINKS[3]}>sing</L>, <Link to="/blog">write</Link>,{" "}
          <L to={LINKS[4]}>play video games</L>, <L to={LINKS[5]}>program</L>,
          and travel when I can. You&apos;ll find most of my work on this
          website, so feel free to explore!
        </p>
      </Layout>
    );
  }
