...
export default function MusicPage(props: PageProps) {
  return (
    ...
    >
      <ul>
        <li><L to="https://www.youtube.com/watch?v=bL5LXOtVdQM">Back in Black</L>, <b>AC/DC</b>, drum cover. June 2023.</li>
        <li><L to="https://www.youtube.com/watch?v=GMvmfZ6w6Ws">Hymn for the Weekend</L>, <b>Coldplay</b>, drum cover. April 2023.</li>
        <li><L to="https://www.youtube.com/watch?v=M83aGZKBB9s">Fight for Your Right</L>, <b>Beastie Boys</b>, drum cover. February 2023.</li>
        <li>
